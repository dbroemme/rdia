...
if(is_home == "true"){
    jQuery(function() {
        ...
        $(window).scroll(function() {
            ...
            if (windscroll >= 40) { jQuery("#main_menu").not('.skip_stick').addClass("subMenu_stick"); } else { jQuery("#main_menu").not('.skip_stick').removeClass("subMenu_stick"); }
        ...
        skills.find(".skillbar-title .toggle").click(function(){ $(this).closest(".skillbar-title").toggleClass("open"); return false; });
    ...
    //$(window).scroll(function() {
    //    var windscroll = $(window).scrollTop();
    //    if (windscroll >= 40) { jQuery("#main_menu").addClass("subMenu_stick"); } else { jQuery("#main_menu").removeClass("subMenu_stick"); }
    //}).scroll();
